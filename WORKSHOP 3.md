...
![image](https://github.com/alinaminignomi/WORKSHOPS/blob/main/W3z1.jpg)
Ссылка на таблицу: (https://docs.google.com/spreadsheets/d/1vLyk_iHSuXQZ5R6hlU90y0YUJUUBPSjUxAXUvdG7Mv0/edit?gid=0#gid=0)

- Из таблицы можно заметить, что скорость дракона и частота появления яйца распределены равномерно. Это, безусловно, является положительным моментом, поскольку поддерживает баланс в игре.

- Количество щитов изменяется каждые три уровня, и эта переменная позитивно влияет на веселость игрового процесса, при этом на первый взгляд не вызывает нарушения баланса.
...
```
Объект отвечающий за загрузку,хранение или передачу:
![image](https://github.com/alinaminignomi/WORKSHOPS/blob/main/W3z2.jpg)
...
![image](https://github.com/alinaminignomi/WORKSHOPS/blob/main/W3z3.jpg)
...
Далее нужно передать каждому объект параметры: 
![image](https://github.com/alinaminignomi/WORKSHOPS/blob/main/W3z4.jpg)
...
![image](https://github.com/alinaminignomi/WORKSHOPS/blob/main/W3Z5.jpg)
...
## Выводы
Я овладела навыками работы с параметрами баланса, научилась визуализировать их, рассчитывать и применять алгоритм изменения параметров в Unity, используя Python и Google Таблицы.
